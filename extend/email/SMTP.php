...
class SMTP
{
     ...
     * represents the server name. In cas of HELO it is the only element of the array.
     ...
     * in cas that function is not available
     ...
     * In cas of HELO, the only parameter that can be discovered is a server name.
     * @access protected
